...
一个小练习，文件存在数据库里快，还是存在硬盘里面快，写一个程序展示一下，尽管想用其他语言(python多好)，但是考虑到具体情况，还是用C#吧  
...
> 刚起初for循环的次数是100次，运行了几次就快10个G了，比较浪费固态，调成了10次。
在我电脑上很奇怪三个写入本地的时间都是一样的，大概是因为固态或者磁盘缓存加速之类的原因。  
没什么说的了，上图
